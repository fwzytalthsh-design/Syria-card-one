...
# --------------------------------------------------
# إشعار طلب الإيداع الجديد مع إيموجيات البريميوم
# --------------------------------------------------
...
# Ensure sidebar_font_size key exists for backward compatibility
...
<pre>[
    ...
    <div class="section">
        ...
        <p style="font-size: 0.85rem; color: var(--subtext); margin-top: 5px;">إنشاء طلب جديد. يجب تضمين order_uuid فريد لمنع تكرار الطلبات.</p>
        <div style="font-size: 0.8rem; margin-top: 10px; color: var(--accent);">مثال على الاستجابة:</div>
<pre>{
    "status": "OK",
    "data": {
...
<head>
    ...
    <style id="dynamicStyles">
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Currency selector box in sidebar */
        ...
        #authModal.active, #registerModal.active { display: flex; }
        ...
        /* Counter category - quantity input styles */
        .counter-qty-box {
            width: 100%; padding: 14px 18px; background-color: #1a1730;
...
<body>
    ...
    <div class="modal-overlay" id="purchaseModal">
        <div class="modal-box">
            ...
            <!-- Counter quantity input - hidden by default -->
    ...
    <script>
        ...
        function openPurchaseModal(subcat) {
            ...
            // Show/hide counter quantity box
        ...
        if self.path == "/api/register":
            ...
            for sub in SUBCATEGORIES_DATA:
                if sub.get('api_product_id'):
                    ...
                    # Update counter_min_price if counter category
            ...
            if email in USERS_DATA:
                ...
                if api_product_id and PROVIDERS_DATA:
                    ...
                    # Build order URL with quantity for counter categories
